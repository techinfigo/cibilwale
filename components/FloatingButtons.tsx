...
export default function FloatingButtons() {
  return (
    <div
      className="fixed right-4 bottom-4 z-50 flex flex-col gap-3.5"
    ...
    >
      <a
        ...
        className="flex h-16 w-16 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_10px_28px_-6px_rgba(37,211,102,0.65)] ring-4 ring-white/70 transition-transform duration-200 hover:scale-110 hover:bg-[#1da851]"
      >
        <svg
          viewBox="0 0 24 24"
          fill="currentColor"
      ...
      <a
        ...
        className="flex h-16 w-16 items-center justify-center rounded-full bg-navy-800 text-white shadow-[0_10px_28px_-6px_rgba(10,37,64,0.6)] ring-4 ring-white/70 transition-transform duration-200 hover:scale-110 hover:bg-navy-700"
      >
        <svg
          viewBox="0 0 24 24"
          fill="currentColor"
